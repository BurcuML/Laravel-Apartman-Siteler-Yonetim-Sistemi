...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user, $id)
    {
        ...
        if ($request->file('image')!=null){
            $data->profile_photo_path = Storage::putFile('profile_photos', $request->file('image')); //file upload
        }
        $data->save();
    ...
    {
        //önce userın bilgilerini çektik daha sonra rolellerin bilgilerini çektik
        $data=User::find($id);
        $datalist =Role::all()->sortBy('name');
    ...
    public function user_role_store(Request $request, User $user, $id)
    {
        ...
        $user->roles()->attach($roleid);#manytomany ilişkiisine veri ekler
    ...
    public function user_role_delete(Request $request, User $user, $userid, $roleid)
    {
        ...
        $user->roles()->detach($roleid); #manytomany ilişkiisinden verilen rolü siler
