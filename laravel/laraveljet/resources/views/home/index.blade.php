...
@section('title', 'Apartman Siteler Yöneim Sistemi')

@section('description')
     Apartmanımıza Hoşgeldiniz...
@endsection

@section('keywords', 'servisler, hizmetler, iletişim')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Birlikte Karar Verme</h4>
